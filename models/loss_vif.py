...
from .fourier_loss import FFTLoss, FFTV10Loss, FFTV10Y1Loss
...
class fusion_loss_vif(nn.Module):
    ...
    def forward(self, image_A, image_B, image_fused):
        ...
        loss_SSIM = 0.5 * (1 - self.L_SSIM(image_A, image_B, image_fused))
        loss_Fourier = self.L_Fourier(image_A, image_fused) + self.L_Fourier(image_B, image_fused)
        fusion_loss = 20*loss_l1 + loss_gradient + loss_SSIM + loss_Fourier
