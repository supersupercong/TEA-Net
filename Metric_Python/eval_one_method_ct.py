...
if __name__ == '__main__':
    ...
    dataset_name = 'CT'
    ir_dir = os.path.join('/data6/weiwang/medical/data/fusion_data/Med/Havard-Medical-Image-Fusion-Datasets-main/MyDatasets/CT-MRI/test', 'CT')
    vi_dir = os.path.join('/data6/weiwang/medical/data/fusion_data/Med/Havard-Medical-Image-Fusion-Datasets-main/MyDatasets/CT-MRI/test','MRI')
    # dataset_name = 'PET'
    ...
    Method = 'ours'
    f_dir = '/data6/weiwang/medical/code/224-c-g-s/save_images_ct'
    save_dir = './Metric'
