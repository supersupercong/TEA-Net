...
if __name__ == '__main__':
    ...
    # dataset = 'SPECT'
    # ir_dir = os.path.join(dataroot, dataset, 'MRI1')
    # vi_dir = os.path.join(dataroot, dataset, 'SPECT1')
    # dataset = 'Lytro'
    # ir_dir = os.path.join(dataroot, dataset, 'A')
    # vi_dir = os.path.join(dataroot, dataset, 'B')
    dataset = 'MEFB'
    ir_dir = os.path.join(dataroot, dataset, 'high')
    vi_dir = os.path.join(dataroot, dataset, 'low')
    ...
    # Method_list = ['TarDAL', 'SwinFusion', 'U2Fusion', 'CDDFuse', 'ReCoNet', 'IFCNN', 'SuperFusion']
    # Method_list = ['FusionDN', 'GCF', 'MFF-GAN', 'U2Fusion', 'x']
    # Method_list = ['DPCN', 'EMFusion', 'MSRPAN', 'SwinFusion', 'TIM', 'zero', 'u2fusion']
    Method_list = ['BHF', 'SwinFusion', 'U2Fusion', 'aio_40', 'aio_66', 'aio_112']
    for i, Method in enumerate(Method_list):
        ...
        for _, item in enumerate(eval_bar):
            ...
            # f_name = '.'+f_name.split('.')[1]+'_'+Method+'.'+f_name.split('.')[2]
