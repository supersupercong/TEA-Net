...
def evaluation_one(ir_name, vi_name, f_name):
    ...
    # return EN, SF, AG, SD, CC, SCD, VIF, MSE, PSNR, Qabf, Nabf, SSIM, MS_SSIM
...
if __name__ == '__main__':
    ...
    dataset_name = 'SPECT'
    ir_dir = os.path.join('/data6/weiwang/medical/data/fusion_data/Med/Havard-Medical-Image-Fusion-Datasets-main/MyDatasets/SPECT-MRI/test', 'SPECT')
    vi_dir = os.path.join('/data6/weiwang/medical/data/fusion_data/Med/Havard-Medical-Image-Fusion-Datasets-main/MyDatasets/SPECT-MRI/test','MRI')
    # dataset_name = 'PET'
    # ir_dir = os.path.join('./datasets', dataset_name, 'PET')
    # vi_dir = os.path.join('./datasets', dataset_name, 'MRI')
    # dataset_name = 'SPECT'
    # ir_dir = os.path.join('./datasets', dataset_name, 'SPECT')
    # vi_dir = os.path.join('./datasets', dataset_name, 'MRI')
    # dataset_name = 'Lytro'
    # ir_dir = os.path.join('./datasets', dataset_name, 'A')
    # vi_dir = os.path.join('./datasets', dataset_name, 'B')
    # dataset_name = 'MEFB_total'
    # ir_dir = os.path.join('./datasets', dataset_name, 'high')
    # vi_dir = os.path.join('./datasets', dataset_name, 'low')
    Method = 'ours'
    f_dir = '/data6/weiwang/medical/code/224-c-g-s/save_images_spect'
    save_dir = './Metric'
    ...
    for _, item in enumerate(eval_bar):
        ...
        # EN, SF, AG, SD, CC, SCD, VIF, MSE, PSNR, Qabf, Nabf, SSIM, MS_SSIM = evaluation_one(ir_name, vi_name, f_name)
        EN_list.append(EN)
        MI_list.append(MI)
        SF_list.append(SF)
        AG_list.append(AG)
