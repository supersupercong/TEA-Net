...
if __name__ == '__main__':
    ...
    dataset_name = 'PET'
    ir_dir = os.path.join('/data6/weiwang/medical/data/fusion_data/Med/Havard-Medical-Image-Fusion-Datasets-main/MyDatasets/PET-MRI/test', 'PET')
    vi_dir = os.path.join('/data6/weiwang/medical/data/fusion_data/Med/Havard-Medical-Image-Fusion-Datasets-main/MyDatasets/PET-MRI/test','MRI')
    # dataset_name = 'PET'
    ...
    Method = 'ours'
    f_dir = '/data6/weiwang/medical/code/224-c-g-s/save_images_pet_212'
    save_dir = './Metric'
