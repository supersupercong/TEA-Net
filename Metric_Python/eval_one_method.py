...
if __name__ == '__main__':
    ...
    dataset_name = 'SPECT'
    ir_dir = os.path.join('/home/hexuanhua/fusion_data/Med/Havard-Medical-Image-Fusion-Datasets-main/MyDatasets/SPECT-MRI/test', 'SPECT')
    vi_dir = os.path.join('/home/hexuanhua/fusion_data/Med/Havard-Medical-Image-Fusion-Datasets-main/MyDatasets/SPECT-MRI/test','MRI')
    # dataset_name = 'PET'
    ...
    Method = 'ours'
    f_dir = '/home/hexuanhua/TCSVT-Mamba/save_images'
    save_dir = './Metric'
