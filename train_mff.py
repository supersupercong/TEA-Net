...
class CoolSystem(pl.LightningModule):
    def __init__(self):
        ...
        # val datasets
        self.validation_datasets = __dataset__[config["train_dataset"]](config, is_train=False, is_label=False, is_ycbcrA=True, is_ycbcrB=True)
    ...
    def validation_step(self, data, batch_idx):
        ...
        # 这下面加指标
        quality = self.loss(guide, source, fusion)[0]
...
def main():
    ...
    parser.add_argument('-c', '--config', default='./configs/Train_mff.json', type=str,
