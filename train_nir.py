...
class CoolSystem(pl.LightningModule):
    def __init__(self):
        ...
        # val datasets
        self.validation_datasets = __dataset__[config["train_dataset"]](config, is_train=False, is_label=False, is_grayA=True, is_ycbcrB=True)
    ...
    def training_step(self, data):
        ...
        fusion = self.MambaFusion(source, guide, config["scale"])
    ...
    def validation_step(self, data, batch_idx):
        ...
        # save_image(fusion, os.path.join(self.save_path, file[0][0:3]+'.jpg'))
...
def main():
    ...
    parser.add_argument('-c', '--config', default='./configs/Train_nir.json', type=str,
    ...
    checkpoint_callback = ModelCheckpoint(
        monitor='quality',
        dirpath=PATH,
        filename='best_model-epoch:{epoch:02d}-loss:{quality:.4f}',
