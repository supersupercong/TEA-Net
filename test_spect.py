...
def main():
    ...
    parser.add_argument('-c', '--config', default='./configs/Train_spect.json', type=str,
    ...
    parser.add_argument('-val_path',
                        default='/data6/weiwang/medical/code/224-c-g-s/Experiments/MED/SPECT/EXP0/best_model-epoch:99-Q:14.8439.ckpt',
